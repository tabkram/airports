...
app/                    --> all of the source files for the application
  ...
  query/                --> the query view template and logic
    query.html            --> the partial template
    query.js              --> the controller logic
    query_test.js         --> tests of the controller
  reports/                --> the reports view template and logic
    reports.html            --> the partial template
    reports.js              --> the controller logic
    reports_test.js         --> tests of the controller
